	...
	for _, tc := range []struct {
		...
		},
		{
			...
			want: arrow.NewSchema([]arrow.Field{
				...
				{Name: "ArrayInt32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Int32)},
				{Name: "ArrayInt64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Int64)},
				{Name: "ArrayUInt32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Uint32)},
				{Name: "ArrayUInt64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Uint64)},
				{Name: "ArrayFloat32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Float32)},
				{Name: "ArrayFloat64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Float64)},
				{Name: "N", Type: arrow.PrimitiveTypes.Int32},
				{Name: "SliceInt32", Type: arrow.ListOf(arrow.PrimitiveTypes.Int32)},
				{Name: "SliceInt64", Type: arrow.ListOf(arrow.PrimitiveTypes.Int64)},
				{Name: "SliceUInt32", Type: arrow.ListOf(arrow.PrimitiveTypes.Uint32)},
				{Name: "SliceUInt64", Type: arrow.ListOf(arrow.PrimitiveTypes.Uint64)},
				{Name: "SliceFloat32", Type: arrow.ListOf(arrow.PrimitiveTypes.Float32)},
				{Name: "SliceFloat64", Type: arrow.ListOf(arrow.PrimitiveTypes.Float64)},
			}, nil),
		},
		{
			...
			want: arrow.NewSchema([]arrow.Field{
				{Name: "evt", Type: arrow.StructOf([]arrow.Field{
					...
					{Name: "ArrayI16", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Int16)},
					{Name: "ArrayI32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Int32)},
					{Name: "ArrayI64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Int64)},
					{Name: "ArrayU16", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Uint16)},
					{Name: "ArrayU32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Uint32)},
					{Name: "ArrayU64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Uint64)},
					{Name: "ArrayF32", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Float32)},
					{Name: "ArrayF64", Type: arrow.FixedSizeListOf(10, arrow.PrimitiveTypes.Float64)},
					{Name: "N", Type: arrow.PrimitiveTypes.Int32},
